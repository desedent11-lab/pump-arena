...
function shell(content){ app.innerHTML = `<main class="app-shell${activeThemeClass()}"><section class="hero"><h1 class="logo">Pump Arena</h1><div class="subtitle">${lang ? t('tagline') : 'Crypto PvP battle prototype'}</div></section>${content}<div class="footer-note">MVP v7 · real battle · no install</div></main>`; if(typeof window.refreshPumpArenaUiChrome === 'function') setTimeout(window.refreshPumpArenaUiChrome, 0); }
